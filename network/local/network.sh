...
# genesis block is defined using the "four" profile at the bottom
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_hospital docker_patient docker_pharmacy docker_insurance docker_orderer1
...
CLI_DELAY=3
# channel name defaults to " hcchannel "
